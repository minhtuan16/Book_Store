...
//		
////		List<ProductSize> productSizes = productSizeRepo.findAll();
////		model.addAttribute("productSizes", productSizes);
//		
//		return "admin/billitems/create";
//	}
//	
//	@PostMapping("/create")
//	public String create(@ModelAttribute BillItems billItems) {
////		System.out.println(billItems.getBill().getDiscount());
////		double payment = ((billItems.getQuantity() * billItems.getProduct().getPrice())-((((billItems.getQuantity()) * (billItems.getProduct().getPrice()))*(billItems.getBill().getDiscount()))/100));
////		billItems.setBuyPrice(payment);
//		billItemsRepo.save(billItems);
//		return "redirect:/admin/billitems/search";
//	}
//	
//	@GetMapping("/update")
